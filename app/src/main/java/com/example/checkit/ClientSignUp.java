...
public class ClientSignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mechanicButton.setOnClickListener(v -> {
            Intent intent = new Intent(ClientSignUp.this, MechanicSignUp.class);
            ...
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(ClientSignUp.this, pairs);
