...
public class DynamicRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            viewHolder.progress.setProgress(items.get(position).getProgress());
            viewHolder.carModel.setText(items.get(position).getCarModel());
            viewHolder.plateNumber.setText(items.get(position).getPlateNumber());
            viewHolder.progressText.setText(items.get(position).getProgressText());
        }
